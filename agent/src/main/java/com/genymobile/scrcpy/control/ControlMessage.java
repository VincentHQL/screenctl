...
public final class ControlMessage {
    ...
    public static final int TYPE_SCREEN_SHOT = 18;
    public static final int TYPE_GET_APP_ICON = 19;
    ...
    public static ControlMessage createScreenShot(int width, int height) {
        ControlMessage msg = new ControlMessage();
